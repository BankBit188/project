...
// -----------------------------------------------------------------
// 1. HEADER WIDGET (ส่วนหัวข้อ + ปุ่มย้อนกลับ + ไอคอนธีมดิน)
// -----------------------------------------------------------------
class EarthHeaderWidget extends StatelessWidget {
  final VoidCallback onBackPressed;

  const EarthHeaderWidget({super.key, required this.onBackPressed});
  ...
  Widget build(BuildContext context) {
    return Row(
      children: [
        ...
        const Icon(Icons.landscape_rounded, color: Color(0xFF4A7C59), size: 28),
      ],
    );
  }
}
...
// -----------------------------------------------------------------
class EarthSearchWidget extends StatelessWidget {
  final TextEditingController controller;
  final String searchQuery;
  final ValueChanged<String> onSearchChanged;
  final VoidCallback onClearSearch;

  const EarthSearchWidget({
    super.key,
...
// -----------------------------------------------------------------
// 3. ITEM CARD (การ์ดแสดงรายการดิน - คงรูปแบบเดิมตามที่กำหนด)
// -----------------------------------------------------------------
class EarthItemCard extends StatelessWidget {
  final String title;
...
// -----------------------------------------------------------------
// 4. PAGINATION WIDGET (ปรับสไตล์ปุ่มเปลี่ยนหน้าให้แมตช์ธีม)
// -----------------------------------------------------------------
class EarthPaginationWidget extends StatelessWidget {
  final int currentPage;
  final int lastPage;
  final ValueChanged<int> onPageChanged;

  const EarthPaginationWidget({
    super.key,
