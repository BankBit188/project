...
// -----------------------------------------------------------------
// 1. HEADER WIDGET (ส่วนหัวข้อ + ปุ่มย้อนกลับ + ไอคอน)
// -----------------------------------------------------------------
class EarthTypeHeaderWidget extends StatelessWidget {
  final VoidCallback onBackPressed;

  const EarthTypeHeaderWidget({super.key, required this.onBackPressed});
  ...
  Widget build(BuildContext context) {
    return Row(
      children: [
        ...
        const Icon(Icons.grass_rounded, color: Color(0xFF4A7C59), size: 26),
      ],
    );
  }
}
...
// -----------------------------------------------------------------
class EarthTypeSearchWidget extends StatelessWidget {
  final TextEditingController controller;
  final String searchQuery;
  final ValueChanged<String> onSearchChanged;
  final VoidCallback onClearSearch;

  const EarthTypeSearchWidget({
    super.key,
...
// -----------------------------------------------------------------
// 3. FILTER SECTION (ปุ่มเลือกประเภทดิน + เมนูกรองประเภทพืช)
// -----------------------------------------------------------------
class EarthTypeFilterSection extends StatelessWidget {
  final String selectedSoilType;
  final String selectedPlantType;
  final ValueChanged<String> onSoilTypeSelected;
  final ValueChanged<String> onPlantTypeSelected;

  const EarthTypeFilterSection({
    super.key,
      ...
      children: [
        ...
        PopupMenuButton<String>(
          icon: Container(
            ...
            decoration: BoxDecoration(
              color: selectedPlantType == "ทั้งหมด"
  ...
  Widget _buildFilterChip(String label) {
    bool isActive = selectedSoilType == label;
    return GestureDetector(
      onTap: () => onSoilTypeSelected(label),
...
// -----------------------------------------------------------------
// 4. ITEM CARD (การ์ดแสดงรายการพืช)
// -----------------------------------------------------------------
class EarthTypeItemCard extends StatelessWidget {
  final String title;
  final String imgUrl;
  final VoidCallback onTap;

  const EarthTypeItemCard({
    super.key,
    required this.title,
...
// -----------------------------------------------------------------
// 5. PAGINATION WIDGET (ส่วนปุ่มควบคุมเปลี่ยนหน้า)
// -----------------------------------------------------------------
class EarthTypePaginationWidget extends StatelessWidget {
  final int currentPage;
  final int lastPage;
  final ValueChanged<int> onPageChanged;

  const EarthTypePaginationWidget({
    super.key,
